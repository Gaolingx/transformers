#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/nekomind_moe2/modular_nekomind_moe2.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_nekomind_moe2.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class NekoMindMoe2Attention(nn.Module):
    ...
    def __init__(self, config: NekoMindMoe2Config, layer_idx: int):
        ...
        self.q_a_layernorm = NekoMindMoe2RMSNorm(config.q_lora_rank) if self.q_lora_rank is not None else None
        self.q_b_proj = (
        ...
        self.kv_a_layernorm = NekoMindMoe2RMSNorm(config.kv_lora_rank)
...
class NekoMindMoe2ForgetGate(nn.Module):
...
class NekoMindMoe2DeltaAttention(nn.Module):
...
__all__ = ["NekoMindMoe2ForCausalLM", "NekoMindMoe2Model", "NekoMindMoe2PreTrainedModel"]
