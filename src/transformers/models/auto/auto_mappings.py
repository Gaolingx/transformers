...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict(
    [
        ...
        ("granite_speech5_encoder", "granite_speech5"),
...
IMAGE_PROCESSOR_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("muse_glimmer", {"torchvision": "MuseGlimmerImageProcessor"}),
        ("neomme", {"torchvision": "NeoMMEImageProcessor"}),
